    ...
    <div class="w3-content">
        <div class="w3-twothird">
                <?php
                        ...
                        include "donnee.php";// inclusion de donnee.php pour accéder à la fonction query
                                                $obj = new Donnee(); // création d'un objet classe
                ...
                <th></th>
                        ...
                        <?php
                        // Ici nous faisons une boucle pour parcourir chaque résultat de notre requete.
...
if($_POST)
{
    include_once "requete_insert.php";
        extract($_POST);
        $obj = new RequeteIns();
   /*Création d'un nouvel objet de la classe RequeteIns
    Appel de la méthode publication pour ajouter la publication*/
